...
import com.example.guimoye.arturo.Usuarios.MostrarMensaje;
...
public class MyService extends Service {
    ...
    Vibrator vibra;
    String IP="http://192.168.11.115:8282/arturo/mensaje.php?modelo=1&estado=1";
    ...
    //    Toast.makeText(this.getApplicationContext(),"sapo",Toast.LENGTH_SHORT).show();
       ...
       // builder.setProgress(100,50,false);
        builder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_cast_dark));
                                ...
                                for(int i=0;i<result.length();i++){
                                    ...
                                    if (bandera==false) {
                                        ...
                                        try {
                                            ...
                                            url = new URL("http://192.168.11.115:8282/arturo/mensaje.php?modelo=2&status=0");
