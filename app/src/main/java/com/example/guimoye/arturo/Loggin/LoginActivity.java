...
import com.example.guimoye.arturo.MainActivity;
    ...
    private void attemptLogin() {
        ...
        if (users.length()!=0) {
            if (password.length()!=0) {
                ...
                url="http://192.168.11.115:8282/arturo/usuarios.php?modelo=3&usuario="+users+"&clave="+password+"";
                            ...
                            public void onResponse(String response) {
                                ...
                                if(tipo!=null){
                                    if(tipo.equals("0") || tipo.equals("1") || tipo.equals("2")){
                                        Snackbar.make(vv, "Bienvenido al Sistema.! ", Snackbar.LENGTH_LONG)
