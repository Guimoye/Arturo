...
public class Recuperar extends AppCompatActivity {
    ...
    private String usuario, clave=null, pregunta, respuesta,correo;
    private AutoCompleteTextView txtusuario, txtcorreo, txtpregunta, txtrespuesta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtusuario = (AutoCompleteTextView) findViewById(R.id.txtUsuarioRecuperar);
                        ...
                        if (txtpregunta.getText().length() != 0) {
                            if (txtrespuesta.getText().length() != 0) {
                              ...
                              /*  Toast.makeText(getApplicationContext(),"Aqui deberias recuperar la clave",Toast.LENGTH_LONG).show();
                                ...
                                url="http://192.168.11.115:8282/arturo/usuarios.php?modelo=2" +
                                        "&usuario="+usuario+"" +
                                        "&correo="+correo+"" +
                                        "&pregunta="+pregunta+"" +
                                        "&respuesta="+respuesta+"";
