...
public class MyServiceLocalizame extends Service implements LocationListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        usuario = intent.getStringExtra("usr");
        tipo = intent.getStringExtra("tip");
        Log.e(TAG, "SE LLAMO ONSTARTCOMMAND LOCALIZAMEEeUser :" + usuario);
            ...
            if(voids[0]=="1"){
                ...
                ,10,this); //cada vez que me mueva en metros*/
                                    ...
                                    RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                                     String url="http://192.168.11.115:8282/arturo/ubicacions.php?modelo=6" +
                                            "&usuario="+usuario+"" +
                                            "&tipo="+tipo+"" +
                                            "&latitud="+latitud+"" +
                                            "&longitud="+longitud+"";
                                    ...
                                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                                            new Response.Listener<String>() {
                                                ...
                                                public void onResponse(String response) {
                                                    ...
                                                    Log.e("enviando ","enviandooo: http://192.168.11.115:8282/arturo/ubicacions.php?modelo=6" +
                                                            "&usuario="+usuario+"" +
                                                            "&tipo="+tipo+"" +
                                                            "&latitud="+latitud+"" +
                                                            "&longitud="+longitud+"");
